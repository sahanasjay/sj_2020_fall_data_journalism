...
# Q: which states are returned by this join?
# A: Pennsylvania, Maryland, Virginia, Delaware 
```
## New Joins
...
#answers the question: what is in my deaths table that is not in my population table
...
#answers the question: what is in my population table that is not in my deaths table
